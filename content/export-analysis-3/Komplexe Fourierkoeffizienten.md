...
child:
proof:
  - "[[202511072011 - Beweis für komplexe Fourierkoeffizieten]]"
---
# Definition
...
Und $\phi_n(t) = \sum_{k=-n}^{n} c_k e^{ik\omega t}$ ist das **n-te komplexe Fourierpolynom** von $f$.
# Bemerkungen
...
## Quellen
- [[VL-39-Folien-Ana1-LinA-Winkert-Komplexe-Fourieranalysis.pdf#page=3]]
- [[VL-39-E-Kreide-Ana1-LinA-Winkert-Komplexe-Fourieranalysis.pdf]]
- [[tum_analysis3_EI_KoenigUlbrich-WS2526-skript.pdf#page=9]]
## Übungsaufgaben
