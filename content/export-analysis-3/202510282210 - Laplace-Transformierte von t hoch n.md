...
tags:
  ...
  - baby
aliases:
  - Laplace-Transformierte von t hoch n
  - Beispiel 1.3.19
parent:
siblings:
child:
...
$$
\mathcal{L}[t \to t^n](s) = \frac{n!}{s^{n+1}} \quad \text{für Re}(s) > 0.
$$
[^1]
...
# Referenz
## Verknüpfung
- [[202510282310 - Beweis für Laplace-Transformierte von t hoch n]]
## Quellen
